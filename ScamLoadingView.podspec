#
#  Be sure to run `pod spec lint ScamLoadingView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Shuhei Sowa" => "a1234224576a@yahoo.co.jp" }
  # Or just: s.author    = "Shuhei Sowa"
  # s.authors            = { "Shuhei Sowa" => "a1234224576a@yahoo.co.jp" }
  # s.social_media_url   = "http://twitter.com/Shuhei Sowa"
